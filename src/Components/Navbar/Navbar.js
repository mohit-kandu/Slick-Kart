...
export default function Navbar() {
    ...
    const [bodyWidth, setBodyWidth] = React.useState(document.body.scrollWidth)
    const [navBtnClicked, setClicked] = React.useState(false)
    ...
    const toggleSidebar = () => {
        ...
        let sidebar_btn = document.querySelector(".nav_menu_button")
            ...
            <div className="nav_contents">
                ...
                </div>
                {
                    bodyWidth > 991 ?
                        ...
                        <div>
                            <div className="nav_menu_button" onClick={() => toggleSidebar()}>
                                <MdMenu className="MdMenu" />
                            </div>
                            <Sidebar setClicked navBtnClicked />
