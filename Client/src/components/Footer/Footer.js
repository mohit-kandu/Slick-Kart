        ...
        <>
            <div id="footer_container" className="footer_container">
                ...
                <div>
                    ...
                    <a href="#">privacy</a>
                    <a href="#">site map</a>
                    <a href="#" style={{ textTransform: 'none' }}>EPR Compliance</a>
                </div>
                <div>
                ...
                <div id="footer_title_nonborder">
                    ...
                    <p>Telephone:<span id="phone"> 1800 202 9898</span></p>
                </div>
            </div>
            <div id="footer_container_last" className="footer_container">
                ...
                <div id="social" className="footer_last">
